export const tourLine01 = "Start at the first changed line and skim for the shape of the review.";
export const tourLine02 = "Use page-sized jumps first, then refine your place with smaller moves.";
export const tourLine03 = "Keep the main review stream in view instead of bouncing between files.";
